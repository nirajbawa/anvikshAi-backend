...
class UserModel(Document):
    ...
    bio: Optional[str] = Field(min_length=0, max_length=1000, default=None)  # ✅ Allows empty bio
    ...
    created_at: datetime = Field(default_factory=lambda: datetime.now(timezone.utc))  # ✅ Ensures correct default behavior
    onboarding: bool = Field(default=False)
    premium_package: Optional[PremiumPackage] = Field(default=PremiumPackage.BASIC)  # ✅ Fixed Enum Default
